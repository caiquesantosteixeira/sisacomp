...
@IonicPage()
@Component({
  selector: 'page-turma-reclamacao',
  templateUrl: 'turma-reclamacao.html',
})
export class TurmaReclamacaoPage {
  ...
  goAlunos(turma:turma){
    this.navCtrl.push(AlunosReclamacaoPage,{turma:turma})
  }
